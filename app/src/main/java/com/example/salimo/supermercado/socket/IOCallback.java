 ...
 */
package com.example.salimo.supermercado.socket;
...
public interface IOCallback {
    ...
    /**
     * On disconnect. Called when the socket disconnects and there are no
     * further attempts to reconnect
     */
    void onDisconnect();

    /**
     * On connect. Called when the socket becomes ready so it is now able to
     * receive data
     */
    void onConnect();
     ...
     *
     * @param data the data.
     * @param ack  an {@link IOAcknowledge} instance, may be <code>null</code> if
     *             there's none
     */
    ...
    /**
     * On error. Called when socket is in an undefined state. No reconnect
